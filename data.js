...
const CONTACTS = {
  ...
  "עבודה שבלב": { location: "ממ\"ק בית המדרש", contact: "ניר דהן", phone: "052-6097564" },
...
const SCHEDULE = [
  ...
  { time: "19:45", subject: "עבודה שבלב", teacher: "הרב ידידיה", category: "rabanim", contactKey: "עבודה שבלב", days: ["ראשון"] },
