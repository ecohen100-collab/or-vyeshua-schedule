...
const CATEGORIES = {
  rabanim: { label: "שיעורים רבניים", color: "#1f7a7a" },
...
const CONTACTS = {
  "שיעור הלכה עם הרב חנאל": { location: "אוהלים", contact: "ניר דהן", phone: "052-6097564" },
  "עין איה": { location: "אוהל משה", contact: "אסיר אלמוג", phone: "053-5313276" },
  "כוונה שבלב": { location: "במ\"ק בית המדרש", contact: "דוד לאופר", phone: "050-4542524" },
  "שיעורי הרב יהודע בבקרים": { location: "חדר האוצר", contact: "יחזקאל בלוקה", phone: "052-3121098" },
  "שיעורי הרב יהודע לילדים": { location: "מ\"ד קומה ראשונה", contact: "יונדב אלבז", phone: "054-5391977" },
  "דף יומי בוקר": { location: "פרגולה", contact: "קבוצת בוקר (זום + הקלטות)", phone: "", groupLink: "https://chat.whatsapp.com/FnhfAv7iqvnGcqUvo8juIB" },
  ...
  "שערי אורה": { location: "פרגולה", contact: "אסיר אלמוג", phone: "053-5313276" },
...
const SCHEDULE = [
  ...
  { time: "8:00", subject: "תנ\"ך משנה - סוגיות בעיון", teacher: "הרב יהודע", category: "groups", contactKey: "שיעורי הרב יהודע בבקרים", days: ["שלישי"] },
  { time: "8:00", subject: "מהר\"ל שבת", teacher: "הרב יהודע", category: "groups", contactKey: "שיעורי הרב יהודע בבקרים", days: ["רביעי"] },
  ...
  { time: "10:30", subject: "שיעורי ילדים", teacher: "", category: "groups", contactKey: "שיעורי הרב יהודע לילדים", days: ["שבת"] },

  { time: "16:30", subject: "שיעור הלכה", teacher: "הרב חנאל", category: "rabanim", contactKey: "שיעור הלכה עם הרב חנאל", days: ["שני","חמישי"] },
  ...
  { time: "16:30", subject: "נוסח תפילה - כיתות ה'-ו'", teacher: "הרב יהודע", category: "groups", contactKey: "שיעורי הרב יהודע לילדים", days: ["שלישי"] },
  { time: "16:30", subject: "טעמי המקרא - כיתות ב'-ו'", teacher: "הרב יהודע", category: "groups", contactKey: "שיעורי הרב יהודע לילדים", days: ["שלישי"] },
  { time: "16:30", subject: "חברותות - כיתות ה'-ז' חט\"ב", teacher: "", category: "groups", contactKey: "", days: ["רביעי"] },
  { time: "16:30", subject: "טעמי המצוות", teacher: "הרב חנאל", category: "rabanim", contactKey: "שיעור הלכה עם הרב חנאל", days: ["שבת"] },
  ...
  { time: "19:45", subject: "אור החיים", teacher: "ר' שלמה נוימן", category: "groups", contactKey: "אור החיים", days: ["שלישי"] },
  ...
  { time: "21:00", subject: "עין איה", teacher: "הרב חנאל", category: "rabanim", contactKey: "עין איה", days: ["שבת"] },
