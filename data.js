...
const SCHEDULE = [
  ...
  { time: "10:00", subject: "Shiur en français", teacher: "הרבנית", category: "women", contactKey: "Shiur en français", days: ["שני"], lang: "צרפתית", audience: ["נשים"] },
  { time: "10:30", subject: "דרשת שבת של מו\"ר", teacher: "", category: "rabanim", contactKey: "", days: ["שבת"] },
  { time: "10:30", subject: "Shiur en français", teacher: "", category: "rabanim", contactKey: "", days: ["שבת"], lang: "צרפתית" },
  { time: "10:30", subject: "Shiur en español", teacher: "", category: "rabanim", contactKey: "Shiur en español", days: ["שבת"], lang: "ספרדית" },
  { time: "10:30", subject: "שיעורי ילדים", teacher: "", category: "groups", contactKey: "שיעורי הרב יהוידע לילדים", days: ["שבת"], audience: ["נוער"] },
  ...
  { time: "19:30", subject: "גמרא תענית - כיתות ז'", teacher: "", category: "groups", contactKey: "גמרא תענית לכיתות ז", days: ["ראשון"], note: "בין מנחה לערבית", audience: ["נוער"] },
  { time: "19:30", subject: "גמרא - כיתה ח'", teacher: "", category: "groups", contactKey: "גמרא לכיתות ח", days: ["חמישי"], note: "בין מנחה לערבית", audience: ["נוער"] },
  { time: "19:30", subject: "נוסח תפילה - כיתות ה'-ו'", teacher: "הרב יהוידע", category: "groups", contactKey: "שיעורי הרב יהוידע לילדים", days: ["שלישי"], note: "בין מנחה לערבית", audience: ["נוער"] },
  { time: "19:30", subject: "טעמי המקרא - כיתות ב'-ו'", teacher: "הרב יהוידע", category: "groups", contactKey: "שיעורי הרב יהוידע לילדים", days: ["שלישי"], note: "בין מנחה לערבית", audience: ["נוער"] },
  { time: "19:30", subject: "חברותות - כיתות ה'-ז' חט\"ב", teacher: "", category: "groups", contactKey: "", days: ["רביעי"], note: "בין מנחה לערבית", audience: ["נוער"] },
  ...
  { time: "19:30", subject: "תורה נוער - לימוד חבורות", teacher: "", category: "groups", contactKey: "תורה נוער", days: ["שני"], audience: ["נוער"] },
  ...
  { time: "20:15", subject: "שיעור לנשות האברכים", teacher: "הרבנית", category: "women", contactKey: "שיעורי הרבנית", days: ["רביעי"], duration: 30, audience: ["נשים"] },
  ...
  { time: "20:45", subject: "שיעור לכלל הנשים", teacher: "הרבנית", category: "women", contactKey: "שיעורי הרבנית", days: ["רביעי"], duration: 75, audience: ["נשים"] },
