...
const SCHEDULE = [
  ...
  { time: "10:30", subject: "שיעורי ילדים", teacher: "", category: "youth", contactKey: "שיעורי הרב יהוידע לילדים", days: ["שבת"] },
  ...
  { time: "19:30", subject: "נוסח תפילה - כיתות ה'-ו'", teacher: "הרב יהוידע", category: "youth", contactKey: "שיעורי הרב יהוידע לילדים", days: ["שלישי"], note: "בין מנחה לערבית" },
  { time: "19:30", subject: "טעמי המקרא - כיתות ב'-ו'", teacher: "הרב יהוידע", category: "youth", contactKey: "שיעורי הרב יהוידע לילדים", days: ["שלישי"], note: "בין מנחה לערבית" },
  ...
  { time: "19:30", subject: "תורה נוער - לימוד חבורות", teacher: "", category: "youth", contactKey: "תורה נוער", days: ["שני"] },
